...
void tim_3x_start(void); 	//режим генератора с 3 выходами 1, 10 и 1000 Гц - выходы PC0, PC1 и PC2
void tim_pwm_start(void);	//режим ШИМ
void timer_stop(void);		//остановка генератора 
